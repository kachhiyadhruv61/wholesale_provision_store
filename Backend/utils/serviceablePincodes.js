...
module.exports = {
  serviceablePincodes: Object.freeze(Array.from(SERVICEABLE_PINCODES)),
  sanitizePincode,
  isServiceablePincode,
  getPincodeDeliveryMessage,
};
